import cinemaBase from "../../assets/recording/cinema-memories-base.webp";
...
import photoBase from "../../assets/recording/photo-corner-base.webp";
import galleryBase from "../../assets/diary/memory-gallery-base.webp";
import storeBase from "../../assets/store/world-boutique-base.webp";

import animalsVideo from "../../assets/recording/great-oak-cinema-animals-v1.png";
import animalsVoice from "../../assets/recording/roar-cave-animals-v1.png";
import animalsWriting from "../../assets/recording/explorer-cabin-writing-animals-v2-standard-book.png";
import animalsPhoto from "../../assets/recording/safari-lookout-photo-animals-v1.png";
import animalsSettings from "../../assets/settings/animal-refuge-clinic-settings-v1.png";
import animalsStore from "../../assets/store/forest-market-store-animals-v1.png";
import animalsGallery from "../../assets/diary/pawprints-museum-gallery-animals-v1.png";

import dinosaursVideo from "../../assets/recording/crystal-cave-cinema-dinosaurs-v1.png";
import dinosaursVoice from "../../assets/recording/fossil-amphitheater-voice-dinosaurs-v1.png";
import dinosaursWriting from "../../assets/recording/ancient-tree-writing-dinosaurs-v1.png";
import dinosaursPhoto from "../../assets/recording/prehistoric-lookout-photo-dinosaurs-v1.png";
import dinosaursSettings from "../../assets/settings/prehistoric-field-station-settings-dinosaurs-v1.png";
import dinosaursStore from "../../assets/store/prehistoric-explorer-market-store-dinosaurs-v1.png";
import dinosaursGallery from "../../assets/diary/cliff-fossil-museum-gallery-dinosaurs-v1.png";

import footballVideo from "../../assets/recording/football-stadium-video-v1.png";
import footballVoice from "../../assets/recording/football-commentary-voice-v1.png";
import footballWriting from "../../assets/recording/football-tactics-writing-v1.png";
import footballPhoto from "../../assets/recording/football-press-photo-v4.png";
import footballSettings from "../../assets/settings/football-locker-settings-v1.png";
...
const baseScenes: PackSceneBackgrounds = {
  video: cinemaBase, voice: voiceBase, writing: writingBase, photo: photoBase, store: storeBase, gallery: galleryBase,
};

const packScenes: Record<string, PackSceneBackgrounds> = {
  base: baseScenes,
  animalesDivertidos: { video: animalsVideo, voice: animalsVoice, writing: animalsWriting, photo: animalsPhoto, settings: animalsSettings, store: animalsStore, gallery: animalsGallery },
  dinosaurios: { video: dinosaursVideo, voice: dinosaursVoice, writing: dinosaursWriting, photo: dinosaursPhoto, settings: dinosaursSettings, store: dinosaursStore, gallery: dinosaursGallery },
  futbol: { video: footballVideo, voice: footballVoice, writing: footballWriting, photo: footballPhoto, settings: footballSettings, store: footballStore, gallery: footballGallery },
  artePintura: { video: artVideo, voice: artVoice, writing: artWriting, photo: artPhoto, settings: artSettings, store: artStore, gallery: artGallery },
  aventuraPirata: { video: pirateVideo, voice: pirateVoice, writing: pirateWriting, photo: piratePhoto, settings: pirateSettings, store: pirateStore, gallery: pirateGallery },
  baloncesto: { video: basketballVideo, voice: basketballVoice, writing: basketballWriting, photo: basketballPhoto, settings: basketballSettings, store: basketballStore, gallery: basketballGallery },
  dulcePasteleria: { video: pastryVideo, voice: pastryVoice, writing: pastryWriting, photo: pastryPhoto, settings: pastrySettings, store: pastryStore, gallery: pastryGallery },
  escuelaMagia: { video: magicSchoolVideo, voice: magicSchoolVoice, writing: magicSchoolWriting, photo: magicSchoolPhoto, settings: magicSchoolSettings, store: magicSchoolStore, gallery: magicSchoolGallery },
  espacio: { video: spaceVideo, voice: spaceVoice, writing: spaceWriting, photo: spacePhoto, settings: spaceSettings, store: spaceStore, gallery: spaceGallery },
  reinoMagico: { video: kingdomVideo, voice: kingdomVoice, writing: kingdomWriting, photo: kingdomPhoto, settings: kingdomSettings, store: kingdomStore, gallery: kingdomGallery },
  superVelocidad: { video: speedVideo, voice: speedVoice, writing: speedWriting, photo: speedPhoto, settings: speedSettings, store: speedStore, gallery: speedGallery },
};

export function getPackSceneBackgrounds(packId?: string) {
  return packScenes[packId ?? "base"] ?? baseScenes;
}
